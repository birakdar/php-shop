...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('dashboard/css/bootsrap-rtl.min.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('dashboard/plugins/morris.js-master/morris.css') }}">
...
<script src="{{ asset('dashboard/plugins/jquery-number/jquery_number.js') }}"></script>
<script src="{{ asset('dashboard/js/printThis.js') }}"></script>
<script src="{{ asset('dashboard/plugins/morris.js-master/morris.js') }}"></script>
